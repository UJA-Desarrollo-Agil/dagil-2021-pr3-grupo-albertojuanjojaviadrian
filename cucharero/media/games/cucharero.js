...
undum.game.situations = {
  ...
  escena3: new undum.SimpleSituation(
    ...
    <br>\
    <p class='transient'>Terminas de observar los posters y al agachar un poco la cabeza te encuentras con un <a href='./sargento'>muñeco de un sargento tenedor</a> de escala \
      ...
      actions: {
        ...
        sargento: function enter(character, system, action) {
          ...
          if (Escena4Visitada) {
            ...
            system.write(
              "<p>¡Anda! Parece que el señor sargento tenía la llave que necesitas. La cogerás prestada, aunque te sientes algo mal por quitarsela.</p>"
            );
          }
        },
      },
